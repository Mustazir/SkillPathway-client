        ...
        <div className={`bg-color2 z-10 md:hidden relative `}>
          <ul className="menu  w-full  text-white  p-0 [&_li>*]:rounded-none">
            <li className="hover:bg-color1 hover:text-white active:bg-color1">
              <Link to={"student_booked_sessions"}>View booked session</Link>
            </li>
            <li className="hover:bg-color1 hover:text-white active:bg-color1">
              <Link to={"student_create_note"}>Create note</Link>
            </li>
            <li className="hover:bg-color1 hover:text-white active:bg-color1">
              <Link to={"student_personal_notes"}>Manage personal notes</Link>
            </li>
            <li className="hover:bg-color1 hover:text-white active:bg-color1">
              <Link to={"student_materials"}>study materials</Link>
            </li>
          </ul>
        </div>
      )}
