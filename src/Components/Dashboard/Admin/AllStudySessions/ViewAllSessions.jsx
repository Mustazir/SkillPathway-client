...
const ViewAllSessions = () => {
    ...
    return (
        <div className="p-6 bg-gray-900 space-y-4 w-full">
            <div className="p-6 sm:p-12 bg-gray-50 text-black dark:bg-gray-950 dark:text-white">
            ...
            <div className="p-6 sm:p-12 bg-blue-950 dark:bg-gray-950 dark:text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {sessions.map((course) => (
                    <div
                    key={course._id}
                    className="bg-white dark:bg-gray-900 dark:text-white rounded-lg shadow-md overflow-hidden flex flex-col"
                >
                    <img
                        src={course.photo}
                        alt={course.title}
            ...
            <div className="p-6 sm:p-12 bg-gray-50 dark:bg-gray-950 dark:text-white flex justify-center items-center gap-6">
                <div className="join">
                    {
                        pages.map((page) => (
