...
const SingleMaterials = () => {
    ...
    return (
        <div className="p-6 bg-gray-200 space-y-4 w-full dark:bg-gray-900 dark:text-white">
            ...
            <div className="p-6 sm:p-12 bg-gray-50 dark:bg-gray-950 dark:text-white">
                <form onSubmit={handelSerssion} className="container flex flex-col mx-auto space-y-12 w-full">
                    <div className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-gray-50 dark:bg-gray-900 dark:text-white">
                        ...
                        <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                            ...
                            <div className="col-span-full sm:col-span-4">
                                ...
                                <input name="duration" type="text" placeholder="http://" className="w-full rounded-md text-gray-900 dark:text-black p-2 border-[1px]" />
                            </div>
                            <div className="col-span-full sm:col-span-2">
                                <label className="text-sm">Study session ID</label>
                                <input name="status" type="text" disabled defaultValue={id} className="w-full rounded-md text-gray-500 dark:text-black p-2 border-[1px]" />
                            </div>
                           
                            <div className="space-y-1 text-sm col-span-full sm:col-span-3">
                                <label  className="block ">Provide a photo</label>
                                <input type="file" name="photo" className="file-input file-input-[#2d3c44] file-input-bordered w-full max-w-xs dark:text-black" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-md shadow-sm bg-gray-50 dark:bg-gray-900 dark:text-white">
